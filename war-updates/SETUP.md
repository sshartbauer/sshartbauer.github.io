...
- `.github/workflows/update-feed.yml` at the repo root: the daily automation.

## Steps you need to do

### 1. Turn on write permission for the Action
...
Commit and push `war-updates/` and `.github/workflows/update-feed.yml`.
...
### 4. Optional: add AP/Reuters-style wire coverage
...
- **Cron schedule**: change the `cron:` line in `.github/workflows/update-feed.yml`. It's currently `0 12 * * *` (daily, 12:00 UTC).
